...
#                                                                             
# PROGRAMMER: MARIA NANDAWULA 
# DATE CREATED:0/11/2023
# REVISED DATE: 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        # 6b. Prints out all the percentages in the results_stats_dic dictionary.
        if key[0] == 'p':
    ...
    if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']):
        ...
        for key in results_dic:
            # 6c. Prints out the pet label and the classifier label
            #     ONLY when the classifier function misclassified dogs.
